...
`done_or_blocked_workspace` opens the same switcher filtered to tabs containing a done or blocked agent. Press Command-D again to cycle, then release Command to switch.
