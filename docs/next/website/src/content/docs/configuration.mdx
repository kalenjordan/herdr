...
`project_picker` opens a typeahead containing open workspaces and repositories found under the configured project directories. Selecting an open workspace focuses it. Selecting an unopened repository creates a workspace there and starts the configured command.
